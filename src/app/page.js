    ...
    <AnimatedContent>
      <main className="min-h-screen bg-black text-white p-4 sm:p-6 md:p-8 lg:p-12 flex flex-col items-center">
        <div className="max-w-2xl w-full px-4 sm:px-6 md:px-8 lg:px-24">
          <div className="flex justify-center mb-6" data-gsap="slide-left">
            <Image
              src="/avatar.png"
              alt="Humayun K."
              width={100}
          ...
          <h1 className="font-stolen-hand text-4xl sm:text-5xl md:text-6xl mb-6 text-center" data-gsap="slide-left">HUMAYUN K.</h1>

          <div data-gsap="slide-up">
